-- =========================================================
-- Schema SQL - Loja de Roupas Draxx (Supabase/PostgreSQL)
-- =========================================================
...
-- Admin inicial (troque o hash pela senha real gerada com bcrypt).
-- Exemplo de senha: "Admin@123"
INSERT INTO users (name, cpf, birth_date, phone, email, password_hash, role)
VALUES ('Admin Draxx', '00000000000', '1990-01-01', '11999999999', 'admin@draxx.com', '$2b$10$REPLACE_HASH', 'admin')
